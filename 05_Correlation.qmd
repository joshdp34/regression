...
::: {.example title="Example 5.7: Finding coefficient of determination for the `trees` model"}
...
::: {.example title="Example 5.8: Interpreting a low coefficient of determination"}
...
::: {.example title="Example 5.9: Choosing slope, correlation, or coefficient of determination"}
